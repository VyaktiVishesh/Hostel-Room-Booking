<?php
    ...
    $stmt=$mysqli->prepare("SELECT email,password,regNo,id FROM userregistration WHERE email=? and password=? ");
        $stmt->bind_param('ss',$email,$password);
        $stmt->execute();
        $stmt -> bind_result($email,$password,$roll,$id);
        $rs=$stmt->fetch();
         $stmt->close();
        $_SESSION['id']=$id;
                ...
                <div class="col-lg-5 col-md-7 bg-white">
                    <div class="p-3">
                        <div class="text-center">
                            <img src="assets/images/big/iiti.png" alt="wrapkit">
                        </div>
